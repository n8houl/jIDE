...
public class JIDE extends JFrame {
	...
	public JIDE() {
		...
		cut.setIcon(new ImageIcon("res/cut.gif"));
		
		cop.setText(null);
		cop.setToolTipText("Copy");
		cop.setIcon(new ImageIcon("res/copy.gif"));
		
		pas.setText(null);
		pas.setToolTipText("Paste");
		pas.setIcon(new ImageIcon("res/paste.gif"));
	...
	Action Run = new AbstractAction("Run", new ImageIcon("res/run.jpg")) {
		/**
		 * 
		 */
		private static final long serialVersionUID = 1L;
	...
	Action Terminate = new AbstractAction("Terminate", new ImageIcon("res/terminate.jpg")) {
		/**
		 * 
		 */
		private static final long serialVersionUID = 1L;
	...
	Action New = new AbstractAction("New", new ImageIcon("res/new.gif")) {
		/**
		 * 
		 */
		private static final long serialVersionUID = 1L;
	...
	Action Open = new AbstractAction("Open", new ImageIcon("res/open.gif")) {
		/**
		 * 
		 */
		private static final long serialVersionUID = 1L;
	...
	Action Save = new AbstractAction("Save", new ImageIcon("res/save.gif")) {
		/**
		 * 
		 */
		private static final long serialVersionUID = 1L;
